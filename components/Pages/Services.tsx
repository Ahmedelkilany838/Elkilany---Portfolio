...
export default function Services() {
  ...
  return (
    <section id="services" className="relative w-full bg-[#050505] py-[80px] md:py-[140px] px-[4%] md:px-[6%] lg:px-[8%] border-b border-white/5 overflow-visible">
      ...
      <div className="flex flex-col w-full border-t border-white/10 mt-8">
        {services.map((service, index) => (
          <div
            ...
            className="group flex flex-col w-full py-8 md:py-12 border-b border-white/10 cursor-pointer transition-colors duration-500 px-4 md:px-6 -mx-4 md:-mx-6"
          >
            {/* Top Row: Title + Icon */}
